...
const ContactSection = () => {
	return (
		<DefaultContainer>
			<section
				id="#contact"
				className="py-20 flex justify-between text-white "
				style={{ height: "100%" }}
			>
				{" "}
				<div className="w-[720px] ">
					...
					>
						<h2 className="text-2xl md:text-3xl font-semibold text-orange-50 mb-5">
							Contact
						</h2>
						<p>
				...
				>
					{" "}
					<Link href="/">
						<span className="text-3xl font-semibold">E.A.L.</span>
					</Link>
